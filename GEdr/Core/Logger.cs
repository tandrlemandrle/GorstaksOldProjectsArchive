...
namespace GEdr.Core
{
    ...
    public static class Logger
    {
        ...
        public static void Log(string message, LogLevel level) { Log(message, level, "gedr_log.txt"); }
        public static void Log(string message) { Log(message, LogLevel.INFO, "gedr_log.txt"); }

...
namespace GIDR.Core
{
    public static class Config
    {
        ...
        public const string EDRName = "GIDR";
        ...
        static Config()
        {
            ...
            PidFilePath = Path.Combine(DatabasePath, "gidr.pid");
            ...
            EvidencePath = Path.Combine(InstallPath, "Evidence");
        ...
        {
            string[] dirs = new string[] { LogPath, QuarantinePath, DatabasePath, ReportsPath, RulesPath, ToolsPath, EvidencePath };
        ...
        // ── IDR / IncidentResponse config ────────────────────────────────────

        /// <summary>Current GIDR version string.</summary>
        public static readonly string Version = "6.3.0";

        /// <summary>Directory where forensic evidence cases are stored.</summary>
        public static readonly string EvidencePath;

        /// <summary>Optional alert email address loaded from config.json.</summary>
        public static string AlertEmail = "";

        /// <summary>
        /// Get a string value from the dynamic config bag (populated by ConfigLoader).
        /// Falls back to <paramref name="defaultValue"/> if the key is absent.
        /// </summary>
        public static string Get(string key, string defaultValue)
        {
            string val;
            if (_dynamicConfig.TryGetValue(key, out val))
                return val;
            return defaultValue;
        }

        /// <summary>
        /// Get a boolean value from the dynamic config bag.
        ...
        /// <summary>
        /// Set a dynamic config value (called by ConfigLoader when parsing config.json).
        /// </summary>
        ...
        // Backing store for dynamic config values (string key → string value).
        private static readonly Dictionary<string, string> _dynamicConfig =
